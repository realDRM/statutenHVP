...
\date{Versie 20 mei 2015}
%\date{Versie \today} % Vul datum in als je dit in de header wilt en niet wilt valsspelen zoals hierboven

\begin{document}
\maketitle

\begin{versionhistory}
  \vhEntry{1.0}{20/05/2015}{Dennis D'Ooghe}{Definitieve versie goedgekeurd door de oprichtingsvergadering}
\end{versionhistory}
...
\begin{titel}\ttext{Het bestuur}
  ...
  \begin{artikel}\ttextcr
    Elk bestuurslid kan zich op de bestuursvergadering laten vertegenwoordigen door een ander bestuurslid mits voorgaande kennisgeving aan de voorzitter.
    Elk bestuurslid kan op dergelijke wijze slechts 1 ander lid vertegenwoordigen.
  \end{artikel}

  \begin{artikel}\ttextenum
    \begin{enumerate}
      \item Het bestuur kan slechts geldig vergaderen wanneer de helft van het bestuur aanwezig of vertegenwoordigd is.
      \item Elk aanwezig of vertegenwoordigd bestuurslid heeft 1 stem, ongeacht het aantal uitgeoefende bestuursfuncties.
      \item
...
% LAYOUT FIX // VERWIJDER INDIEN ER AANPASSINGEN GEBEUREN VOOR DIT PUNT
\newpage
% END FIX
